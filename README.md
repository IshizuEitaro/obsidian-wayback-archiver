...
- [Settings Guide](#settings-guide)
    ...
    - [Profile Settings](#profile-settings)
        ...
        - [Fallback Archive Providers](#fallback-archive-providers)
        - [archive.today Pending Queue Options](#archive-today-pending-queue-options)
        - [Per-URL Archive Policies](#per-url-archive-policies)
        - [Advanced Settings](#advanced-settings)
        - [SPN API v2 Options](#spn-api-v2-options)
- [Troubleshooting FAQ](#troubleshooting-faq)
- [Limitations](#limitations)
    - [Experimental: archive.today auto-submit](#experimental-archive-today-auto-submit)
- [LICENSE](#license)
...
- **Supported Providers:**
    ...
    - `archiveToday:auto`: attempts experimental background submission, then resolves the resulting snapshot later if available. See [Experimental: archive.today auto-submit](#experimental-archive-today-auto-submit) before enabling this.
